...
export const EditorDispatcherContext = React.createContext<
...
// 提供当前选中的Instance实例
export const EditorSelectedInstanceContext = React.createContext<
  VCD.ComponentInstance | undefined
>(undefined);
// 提供当前悬浮的Instance实例
export const EditorHoveredInstanceContext = React.createContext<
  VCD.ComponentInstance | undefined
>(undefined);
...
// 提供根节点Instance
export const EditorRootInstanceContext = React.createContext<
  VCD.ComponentInstance | undefined
>(undefined);

// 提供编辑器尺寸数据
export const EditorSizeContext = React.createContext<VCD.EditorSize>({
  width: '100%',
  height: '100%',
