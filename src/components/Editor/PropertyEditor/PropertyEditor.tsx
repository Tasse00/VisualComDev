...
import { useEditor, useEditorSelectedInstance } from '../Providers/Editor/hooks';
...
const PropertyEditor: React.FC<{
  ...
  let children = (
    <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description='Select An Instance' />
  );
  if (instance) {
        ...
        <div className={styles['fields']}>
          {
            properties.map(p => {
              ...
              if (!fieldEditor) {
                ...
                input = <InputCom value={currValue} update={update} params={p.params} editors={fieldEditorsMap} />
              }
